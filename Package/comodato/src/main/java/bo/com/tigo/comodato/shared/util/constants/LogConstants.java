...
public class LogConstants {
    ...
    public static final String LOG_WS_REQUEST = "LOG_WS: REQUEST [${WS_NAME}][TRANSACTION_ID:${UUID}, SECUENCIA:1, DATETIME:${DATETIME}, USER:${USER}, CHANNEL:${CHANNEL}, REQUEST:${REQUEST}]";
    public static final String LOG_WS_OBJECT_REQUEST = "LOG_PLEX: REQUEST [${OBJECT_NAME}][TRANSACTION_ID:${UUID}, SECUENCIA:1, DATETIME:${DATETIME}, USER:${USER}, REQUEST:${REQUEST}]";
    public static final String LOG_REQUEST_POST = "HTTP-METHOD:POST, HEADERS => ${HEADERS}, PAREMETERS => {}, BODY => ${BODY}";
    public static final String LOG_WS_RESPONSE = "LOG_WS: RESPONSE [${WS_NAME}][TRANSACTION_ID:${UUID}, SECUENCIA:2, DATETIME:${DATETIME}, URL:${URL}, RESULT:${RESULT}, CODE:${CODE}, DESCRIPTION:${DESCRIPTION}, RESPONSE:${RESPONSE}, TIME:${TIME} ms.]";
    public static final String LOG_WS_OBJECT_RESPONSE = "LOG_PLEX: RESPONSE [${OBJECT_NAME}][TRANSACTION_ID:${UUID}, SECUENCIA:2, DATETIME:${DATETIME}, URL:${URL}, RESPONSE:${RESPONSE}, TIME:${TIME} ms.]";
}
